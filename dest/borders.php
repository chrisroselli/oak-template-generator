...
<?php
       ...
       //Update these links for your site
        ...
        $logo = '<a href="/"><img src="http://images.kenmarbasementsystems.com/248/logo.png" alt="[company]" title="[company]" border="0"></a>';

        //This can be awards or special offers. If you have nothing remove this and remove the code further down
        $hotSpot= '<img src="" alt="">';


        $credFooter ='
            <div class="small-6 medium-3 columns">
                <span><img src="http://images.kenmarbasementsystems.com/248/bbb-logo.jpg" alt=""></span>
            </div>
            <div class="small-6 medium-3 columns">
                <span><img src="http://images.kenmarbasementsystems.com/248/lifetime-warranty-transparent.png" alt=""></span>
            </div>
            <div class="small-6 medium-3 columns">
                <span><img src="http://images.kenmarbasementsystems.com/248/acads-logo.jpg" alt=""></span>
            </div>
            <div class="small-6 medium-3 columns">
                <span><img src="http://images.kenmarbasementsystems.com/248/wsib-logo.jpg" alt=""></span>
            </div>
...
array( "service-img" => file_get_contents("http://b388022801b3244fdbae-c913073b3759fb31d6b728a919676eab.r15.cf1.rackcdn.com/v3/templates/icons/fsi.svg"), "service-link" => "/foundation-repair.html", "service-name" => "Foundation Repair", "service-desc" => "We'll find the right solution for your foundation problems." ),array( "service-img" => file_get_contents("http://b388022801b3244fdbae-c913073b3759fb31d6b728a919676eab.r15.cf1.rackcdn.com/v3/templates/icons/cs.svg"), "service-link" => "/crawl-space-repair.html", "service-name" => "Crawl Space Repair", "service-desc" => "We offer complete crawl space encapsulation &amp; repair services." ),array( "service-img" => file_get_contents("http://b388022801b3244fdbae-c913073b3759fb31d6b728a919676eab.r15.cf1.rackcdn.com/v3/templates/icons/basement_waterproofing.svg"), "service-link" => "/basement-waterproofing.html", "service-name" => "Basement Waterproofing", "service-desc" => "We have the most effective solutions for wet basements." ),array( "service-img" => file_get_contents("http://b388022801b3244fdbae-c913073b3759fb31d6b728a919676eab.r15.cf1.rackcdn.com/v3/templates/icons/sump_pump.svg"), "service-link" => "/sump-pump.html", "service-name" => "Sump Pump", "service-desc" => "Sump pump system installation & backup pumps in [state]." )
                ...
                <div class="container" id="header">
                    <div class="row collapse">
                        ...
                        <div class="large-8 columns" id="phone">
                            ...
                            <p onclick="location.href='/service-area.html';" style="cursor:pointer;" id="header-service-area">Proudly serving the greater Sudbury Area - Including North Bay, Elliot Lake, Sultan and nearby</p>
    ...
    <div class="container" id="main-message">
        <div class="main-slide slide1">
          <div class="columns hero-txt main-txt">
             <p>wet basement? <span>We have lasting solutions for waterproofing your basement.</span></p>
           </div>
        </div>
      ...
      <?php
          ...
          ?>
                            ...
                            <div class="container home" id="choose-us">
                                ...
                                <div class="row">
                                    <div class="medium-10 medium-offset-1 large-5 columns"><p class="check">In business since 1984</p></div>
                                    <div class="medium-10 medium-offset-1 large-5 large-offset-0 end columns"><p class="check">Locally owned and operated</p></div>
                                </div>
                                <div class="row">
                                    <div class="medium-10 medium-offset-1 large-5 columns"><p class="check">Award-winning, patented systems and products</p></div>
                                    <div class="medium-10 medium-offset-1 large-5 large-offset-0 end columns"><p class="check"><a href="/free-estimate.html">Free estimates for all of our services</a></p></div>
                                </div>
                    <div class="row">
                        <div class="home-text columns">
                          <h2>H2 content goes here thanks again for your cooperation</h2>
