...
<?php
       ...
       //Update these links for your site
        ...
        $logo = '<a href="/"><img src="<%- logo %>" alt="[company]" title="[company]" border="0"></a>';
        ...
        $credFooter ='
            <div class="small-6 medium-3 columns">
                <span><img src="<%- credImg1 %>" alt=""></span>
            </div>
            <div class="small-6 medium-3 columns">
                <span><img src="<%- credImg2 %>" alt=""></span>
            </div>
            <div class="small-6 medium-3 columns">
                <span><img src="<%- credImg3 %>" alt=""></span>
            </div>
            <div class="small-6 medium-3 columns">
                <span><img src="<%- credImg4 %>" alt=""></span>
            </div>
                ...
                <div class="container" id="header">
                    <div class="row collapse">
                        ...
                        <div class="large-8 columns" id="phone">
                            ...
                            <p onclick="location.href='/service-area.html';" style="cursor:pointer;" id="header-service-area"><%= serviceArea %></p>
    ...
    <div class="container" id="main-message">
        <div class="main-slide slide1">
          <div class="columns hero-txt main-txt">
             <p><%= mainMessageText %> <span><%= mainMessageSubtext %></span></p>
           </div>
        </div>
      ...
      <?php
          ...
          ?>
                            ...
                            <div class="container home" id="choose-us">
                                <div class="row">
                                    <div class="columns"><h2><span><%= whyChooseTitle %></span></h2></div>
                                </div>
                                <div class="row">
                                    <div class="medium-10 medium-offset-1 large-5 columns"><p class="check"><%= whyChooseOne %></p></div>
                                    <div class="medium-10 medium-offset-1 large-5 large-offset-0 end columns"><p class="check"><%= whyChooseTwo %></p></div>
                                </div>
                                <div class="row">
                                    <div class="medium-10 medium-offset-1 large-5 columns"><p class="check"><%= whyChooseThree %></p></div>
                                    <div class="medium-10 medium-offset-1 large-5 large-offset-0 end columns"><p class="check"><a href="/free-estimate.html"><%= whyChooseFour %></a></p></div>
                                </div>
                    <div class="row">
                        <div class="home-text columns">
                          <h2>H2 content goes here thanks again for your cooperation</h2>
